    ...
    <footer className="bg-[#3d4f5c] text-white py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div>
            <h4 className="text-primary font-bold mb-4 text-lg">About Growth</h4>
          ...
          <div>
            <h4 className="text-primary font-bold mb-4 text-lg">Information</h4>
            <ul className="space-y-3 text-sm opacity-80">
              <li><a href="#" className="hover:text-primary transition-smooth">App Store Analytics</a></li>
              <li><a href="#" className="hover:text-primary transition-smooth">Brand Name Generator</a></li>
              ...
              <li><a href="#" className="hover:text-primary transition-smooth">App Policy</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-primary font-bold mb-4 text-lg">Contact Info</h4>
            <ul className="space-y-3 text-sm opacity-80">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="#" className="hover:text-primary transition-smooth">Facebook OmegaTheme</a>
              </li>
              <li className="flex items-center gap-2">
                <Youtube className="w-4 h-4 flex-shrink-0" />
                <a href="#" className="hover:text-primary transition-smooth">Youtube OmegaTheme</a>
              </li>
              <li className="flex items-center gap-2">
                <MessageCircle className="w-4 h-4 flex-shrink-0" />
                <a href="#" className="hover:text-primary transition-smooth">Wechat OmegaTheme</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-sm opacity-70">
          <p className="mb-2">
            Copyright © <a href="#" className="hover:text-primary transition-smooth">XIPAT Flexible Solutions</a>. All Rights Reserved
          </p>
          <p className="text-xs">
